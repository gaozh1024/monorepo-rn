...
const toastStyle = tva({
  ...
  variants: {
    action: {
      error: 'bg-error-700 opacity-80',
      warning: 'bg-warning-700 opacity-80',
      success: 'bg-success-700 opacity-80',
      info: 'bg-info-700 opacity-80',
      muted: 'bg-background-800 opacity-80',
    },
...
const toastTitleStyle = tva({
  base: 'font-medium font-body tracking-md text-center',
  variants: {
    isTruncated: {
      true: '',
    },
...
const toastDescriptionStyle = tva({
  base: 'font-normal font-body tracking-md text-center',
  variants: {
    isTruncated: {
      true: '',
    },
